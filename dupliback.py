...
It makes incremental backups with Duplicity. It is an evolution of myback.py,
also by me.
...
if __name__ == '__main__':
  ...
  # General variables:
  dupli    = 'duplicity '                           # base duplicity command to use
  user     = os.environ['LOGNAME']                  # username of script user
  home     = os.environ['HOME']                     # your home dir
  conf     = '%s/.duplicity' % (home)               # configuration dir
